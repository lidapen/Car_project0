		...
		<div class="main_box new_order">
			...
			<div class="cont_box">
				...
				<div class="norder_box">
					...
					<div class="blue_btn choose_spend choose_serve">
				...
				<div class="norder_box order_state">
					...
					<ul class="pay_box clearfix">
						<li class="radio_box">
							...
							<input type="radio" name="payment" id="11"/><!--以下需要支付方式id-->
							<span id="member">会员</span>
						</li>
						<li class="radio_box">
							<i class="fa fa-circle-thin fa-1x"></i>
						...
						<li class="radio_box">
							<i class="fa fa-circle-thin fa-1x"></i>
							<input type="radio" name="payment"/>
							<span id="free">体验卡（免费）</span>
						</li>
						<li class="radio_box">
							<i class="fa fa-circle-thin fa-1x"></i>
							<input type="radio" name="payment"/>
							<span id="only">邮政（仅限洗车）</span>
						</li>
					</ul>
				</div>
				<!--短信通知-->
